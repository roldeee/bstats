sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("base/stats/app", ".html");
			sHash = sHash || "";
		...
		return Opa5.extend("base.stats.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["base/stats/localService/mockserver"], function (mockserver) {
